...
router.post('/uttupl22', upload.single('pdf'), async (req, res) => {
  try {
    ...
    // Create file path
    const filePath = `uploads/reg2022/utt/${req.file.filename}`;
