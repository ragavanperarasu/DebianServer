...
router.post('/utoupl22', upload.single('pdf'), async (req, res) => {
  try {
    ...
    // Create file path
    const filePath = `uploads/reg2022/uto/${req.file.filename}`;
