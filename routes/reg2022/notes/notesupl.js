...
router.post('/notesupl', upload.single('pdf'), async (req, res) => {
  try {
    ...
    // Create file path
    const filePath = `uploads/reg2022/notes/${req.file.filename}`;
