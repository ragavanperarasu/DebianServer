...
router.post('/booksupl', upload.single('pdf'), async (req, res) => {
  try {
    ...
    // Create file path
    const filePath = `uploads/reg2022/books/${req.file.filename}`;
